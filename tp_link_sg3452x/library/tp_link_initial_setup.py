...
"""
TP-Link SG3452X Initial Setup Module

Erstmalige Einrichtung eines Factory-Reset TP-Link SG3452X via Telnet.
...
short_description: Initial setup of factory-reset TP-Link SG3452X - Password and SSH
description:
