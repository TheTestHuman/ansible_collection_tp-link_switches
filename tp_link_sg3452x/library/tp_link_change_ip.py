...
"""
TP-Link SG3452X IP Address Change Module

Changes IP address, netmask, and gateway on TP-Link SG3452X Managed Switches via SSH.
...
short_description: Change IP address of TP-Link SG3452X via SSH
description:
